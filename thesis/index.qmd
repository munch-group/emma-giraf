...
Hvor hver *T_k* er eksponentialfordelt med parameter $ $

Genealogiske træer genereret af coalescent modellen danner grundlaget for mange statistikker i populationsgenetik. Mutationer antages typisk at opstå langs grenene i det genealogiske træ som en Poisson-proces med rate $ $. Antallet af mutationer på en gren med længde *t* følger dermed en Poissonfordeling
...
En phase-type distribution kan repræsenteres ved en initialfordeling $ $ og en transitionsmatrix *S*, hvor sandsynlighedstætheden er givet ved
