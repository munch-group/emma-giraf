...
fordeling og hybridzonerne er vist i \textbf{?@fig-Kort}. :::
\{\#fig-Kort \}
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{illustrations/Kort.png}

\emph{Papio} baboon arter. Nuværende udbredelse af hver bavianart samt
placeringen af tre veldokumenterede aktive hybridzoner er også vist. x1:
hybridzone mellem \emph{P. hamadryas} og \emph{P. anubis}, x2:
hybridzone mellem \emph{P. cynocephalus} og \emph{P. anubis}, x3:
hybridzone mellem \emph{P. kindae} og \emph{P. ursinus}. Billede fra
{Rogers et al.} (2019).

::: På trods af disse geografiske adskillelser kan flere arter krydse
sig med hinanden i naturen og producere fertile hybrider ({Sørensen et
al.} 2023; {Jordan et al.} 2018). I flere kontaktzoner er der
...
Som det fremgår af \textbf{?@fig-Kort}, overlapper arterne geografisk
...
Oversigten er vist i \textbf{?@tbl-notebooks}. \textbar{} Notebook
\textbar{} Model \textbar{} Parametre \textbar{} Formål \textbar{}
\textbar:---\textbar:---\textbar:---\textbar:---\textbar{} \textbar{}
NB01 \textbar{} Kingmans coalescent \textbar{} \(\theta\) \textbar{}
Verificering af fase-type implementering og analytiske egenskaber
\textbar{} \textbar{} NB02 \textbar{} SVGD-kalibrering \textbar{} Prior,
optimizer, partikler \textbar{} Systematisk valg af
inferenskonfiguration til bavian-analyser \textbar{} \textbar{} NB03
\textbar{} To-ø modellen \textbar{} \(\theta_0\), \(\theta_1\)
\textbar{} Identificerbarhed og sammenligning med method of moments
\textbar{} \textbar{} NB04 \textbar{} Numerisk præcision \textbar{}
\(n\), \(\theta\) \textbar{} Beregningsmæssige grænser og skalering med
prøvestørrelse \textbar{} \textbar{} NB05 \textbar{} Tidsinhomogen
coalescent og IM-modellen \textbar{} \(\theta_0\), \(\theta_1\), \(t_s\)
\textbar{} Flaskehalse, ekspansioner og split-tidspunkter \textbar{}
\textbar{} NB06 \textbar{} Joint probability-inferens \textbar{}
\(\theta\), \(\mu\), \texttt{reward\_limit} \textbar{} Diskrete
SFS-observationer og sammenligning med TMRCA-inferens \textbar{}
\textbar{} NB07A \textbar{} Enkeltpopulationsanalyse \textbar{}
\(\theta\), \(N_e\) \textbar{} SVGD-inferens på bavian-data for seks
\emph{Papio}-arter \textbar{} \textbar{} NB07B \textbar{} To-populations
analyse \textbar{} \(\theta_0\), \(\theta_1\), \(t_s\) \textbar{}
Migration og split-tidspunkter for bavian-artpar \textbar{}

: Oversigt over notebooks og modeller implementeret i dette speciale.
\{\#tbl-notebooks\}
...
\textbf{?@tbl-standard-config} hvilke standardkonfiguration der er valgt
til de efterfølgende analyser. \textbar{} Parameter \textbar{} Valg
\textbar{} Begrundelse \textbar{}
\textbar:---\textbar:---\textbar:---\textbar{} \textbar{} Optimizer
\textbar{} \texttt{Adamelia(0,2)} \textbar{} Lavest gennemsnitlig
posterior-std over bavian-\(\theta\) \textbar{} \textbar{} Prior
(enkeltpopulation) \textbar{} \texttt{DataPrior} \textbar{} Lavest bias
ved bavian-realistiske \(\theta\)-værdier \textbar{} \textbar{} Prior
(migration) \textbar{} \texttt{HalfCauchyPrior} \textbar{}
Positiv-støttet og biologisk korrekt for migrationsrater \textbar{}
\textbar{} Prior (joint probability) \textbar{} \texttt{LogGaussPrior}
\textbar{} Mere kalibreret dækning end DataPrior \textbar{} \textbar{}
Partikler \textbar{} 20 (test) / 60 (bavian) \textbar{} Bedste
std/tid-kompromis fra grid-søgning \textbar{} \textbar{} Iterationer
\textbar{} 300 (1 parameter) / 400 (2 parametre) \textbar{} Konvergerer
stabilt inden disse grænser \textbar{}

: Standard SVGD-konfiguration brugt i alle efterfølgende analyser.
\{\#tbl-standard-config\}
