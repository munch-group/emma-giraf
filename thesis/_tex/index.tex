...
{\bfseries\large June 7, 2026 \par}
\vspace{3ex}
...
enkeltpopulationsmodellen og \(n=6\) til modeller med to populationer.
Valget af \(n=4\) skyldes, at tilstandsrummet er relativt lille, hvilket
gør beregningerne hurtige, samtidig med at prøvestørrelsen indeholder
tilstrækkelig inforamtion til at beskrive coalescenttider og formen af
SFS. I modeller med to populationer anvnedes \(n=6\), da en større
prøvestørrelse er nødvendig for bedre at kunne skelne mellem effekterne
af coalescent og migration.
...
stikprøvestørrelser. DataPrior gav \(34\%\) dækning ved \(n=100\),
\(52\%\) ved \(n=500\) og \(68\%\) ved \(n=2000\). denne prior var
dermed underkalibreret på alle testede niveauer. LogGaussPrior er
markant bedre og opnår \(90\%\) dækning ved \(n=2000\), men når ikke
helt det optimale \(95\%\)-niveau.

Begge priors undervurderer dermed den sande usikkerhed, men i meget
forskellig grad. LogGaussPrior blev valgt til joint probability-inferens
netop fordi den er nærmest korrekt kalibreret.

På baggrund af alle tests i NB02 vises der
...
vist i Figure~\ref{fig-two-conv-cyno-anubis} og
Figure~\ref{fig-two-trace-cyno-anubis}.
